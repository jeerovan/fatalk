...
public class AdapterContacts extends RecyclerView.Adapter<AdapterContacts.ListViewHolder> {

    private static String TAG = AdapterContacts.class.getSimpleName();
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        _dp.setOnClickListener(ActivityContacts.listItemClickListener);
        _userDetail.setOnClickListener(ActivityContacts.listItemClickListener);
